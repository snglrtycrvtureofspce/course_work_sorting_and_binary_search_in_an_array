...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Text = L"Ñîğòèğâêà Õîàğà";
			// 
			// button3
			// 
...
private: System::Void îÏğîãğàììåToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	private:
		int n = 0; // ğàçìåğ äèíàìè÷åñêè íåóïğàâëÿåìîãî Ñáîğùèêîì ìóñîğà ìàññèâà
		int* m = nullptr; //ïîëå-óêàçàòåëü íà öåëî÷èñëåííûé íåóïğàâëÿåìûé ìàññèâ
		int i = 0; // ïîëå-èíäåêñ î÷åğåäíîãî ıëåìåíòà ìàññèâà
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) // random arr and conclusion
{
	try
	{
		...
		if (!m)
		{
			MessageBox::Show("Íå óäà¸òñÿ ñîçäàòü ìàññèâ íà " + n.ToString() + " ıëåìåíòîâ.");
			return;
		}
